  ...
  return (
    <div className={`glass-card border-l-2 ${meta.borderColor} flex flex-col overflow-hidden`}>
      ...
      <ol className="flex flex-col px-3 pb-3 pt-2 gap-1">
        {articles.length === 0 && (
          <li className="text-xs text-[#4a6080] py-3 text-center italic">
        ...
        {articles.map((a, i) => (
          ...
          >
            ...
            <a
              ...
              className="text-xs text-[#c8d8f0] hover:text-white transition-colors leading-snug flex items-center gap-1"
            >
